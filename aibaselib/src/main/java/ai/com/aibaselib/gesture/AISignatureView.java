...
public class AISignatureView extends View {
    ...
    public AISignatureView(Context context) {
        super(context);
        init(context);
    }

    public AISignatureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AISignatureView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void touchMove(MotionEvent event) {
        ...
        final float previousX = mPt.x;
        final float previousY = mPt.y;
